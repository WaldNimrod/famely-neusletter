...
def generate_mock_ncis() -> list[NCI]:
    ...
    mocks = [
        ...
        create_nci("Claude API: Multi-Agent Orchestration Now in Beta", "https://example.com/claude-agents",
        ...
        create_nci("Dezeen Awards 2026: Sustainable Housing Shortlist", "https://example.com/dezeen-awards",
        ...
        create_nci("The Hard Problem of Consciousness: A Chemist's View", "https://example.com/consciousness-chem",
                   "Nature Chemistry", "rss", "https://nature.com/nchem.rss", 0.95, now,
        ...
        create_nci("Aerial Silks: Advanced Drops & Transitions Guide", "https://example.com/aerial-silks",
        ...
        create_nci("Cirque du Soleil Announces New Show: 'Elemental'", "https://example.com/cirque-elemental",
        ...
        create_nci("Mind Your Decisions: The Paradox That Fooled Einstein", "https://example.com/myd-einstein",
